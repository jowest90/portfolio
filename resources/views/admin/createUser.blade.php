...
<<<<<<< HEAD
      <form class="form-horizontal" method="POST" action="{{ route('admin.createUser.submit') }}">
=======
    <div class="panel-heading"><h2>Create User</h2></div>
      <form class="form-horizontal" method="POST" action="{{ url('/admin/createUser') }}">
>>>>>>> parent of 0fbe177... run back
          {{ csrf_field() }}
